    ...
    function render($args, $instance){
	    ...
	    <div class="breadcrumbs pathway">
			...
			if(is_single() && intval($instance['category'])===1) :
				...
				if(!empty($category)) :
					echo '<div class="breadcrumb-wrapper"><div class="module-l"><div class="module-r"><div class="module-inner"><div class="module-inner2"><a class="pathway" href="'.get_category_link($category[0]->cat_ID).'">'.$category[0]->cat_name.'</a></div></div></div></div></div>';
				endif;
			endif;
