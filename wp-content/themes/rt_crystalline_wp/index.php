...
<head>
	...
	<?php
		...
		$gantry->addStyles(array('template.css','wordpress.css','wp.css','style.css','typography.css','customisation.css'));
...
<script>(function(d, s, id) {
  ...
  js.src = "//connect.facebook.net/en_US/sdk.js#xfbml=1&appId=675698892457843&version=v2.0";

  fjs.parentNode.insertBefore(js, fjs);

}(document, 'script', 'facebook-jssdk'));</script>

<script type='text/javascript' src='http://localhost:8888/nacho_live/wp-content/plugins/wp_roktabs/js/roktabs.js'></script>
		...
		<div id="rt-main-header" <?php echo $gantry->displayClassesByTag('rt-main-header'); ?>><div id="rt-header-overlay" <?php echo $gantry->displayClassesByTag('rt-header-overlay'); ?>><div id="rt-main-header2"><div id="rt-header-graphic" <?php echo $gantry->displayClassesByTag('rt-header-graphic'); ?>>
			...
			if(is_home()){
				...
				if (true or $gantry->countModules('showcase')) : ?>
		...
		<?php /** Begin Footer Wrap **/ if ($gantry->countModules('footer-position') or $gantry->countModules('copyright') or $gantry->countModules('debug')) : ?>
